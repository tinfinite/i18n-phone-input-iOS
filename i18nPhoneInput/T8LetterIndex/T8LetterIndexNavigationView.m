...
#import "T8LetterIndexNavigationItem.h"

#define kImageViewTag 888
@interface T8LetterIndexNavigationView()
...
@implementation T8LetterIndexNavigationView
...
- (void)setKeys:(NSArray *)keys
{
    ...
    for (UIView *view in self.subviews) {
        if ([view isKindOfClass:[T8LetterIndexNavigationItem class]]) {
    ...
    for (NSUInteger i=0; i<self.keys.count; i++) {
        T8LetterIndexNavigationItem *item = [[T8LetterIndexNavigationItem alloc]init];
...
#define kIconWidth 10.0f
    ...
    for (T8LetterIndexNavigationItem *item in self.items) {
